...
@pytest.mark.asyncio
async def test_empty_ap_list(create_ajax_session, set_conf_results):
...
@pytest.mark.asyncio
async def test_single_ap(create_ajax_session, set_conf_results):
...
@pytest.mark.asyncio
async def test_multiple_aps(create_ajax_session, set_conf_results):
...
@pytest.mark.asyncio
async def test_empty_client_list(create_ajax_session, set_conf_results):
...
@pytest.mark.asyncio
async def test_single_client(create_ajax_session, set_conf_results):
...
@pytest.mark.asyncio
async def test_multiple_clients(create_ajax_session, set_conf_results):
...
@pytest.mark.asyncio
async def test_mesh_info(create_ajax_session, set_conf_results):
    """Mesh information"""
    async with create_ajax_session() as session:
        set_conf_results(0)
...
@pytest.mark.asyncio
async def test_sys_info(create_ajax_session, set_conf_results):
    """System information"""
    async with create_ajax_session() as session:
        # bare call
        set_conf_results(0)
