...
from .const import (ERROR_CONNECT_NOPARSE, ERROR_INVALID_MAC,
                    ERROR_PASSPHRASE_JS, ERROR_PASSPHRASE_LEN)
...
def cast_timeout(
    timeout: aiohttp.ClientTimeout | int | None,
...
def validate_passphrase(passphrase: str) -> str:
    ...
    if passphrase and re.fullmatch(
        r"[!-~][ -~]{6,61}[!-~]|[0-9a-fA-F]{64}", passphrase
    ):
        return passphrase
...
#     ("acl", "accept"),
#     ("acl", "deny"),
#     ("urlfilteringpolicy", "blacklist"),
#     ("urlfilteringpolicy", "whitelist"),
#     ("group", "radio"),
#     ("group", "ap"),
#     ("wlangroup", "wlansvc"),
#     ("ap-property", "radio"),
